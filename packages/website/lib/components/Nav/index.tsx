...
const NavList = ({ rightItem, children }: NavListProps) => {
  return (
    <Tabs.List className="flex items-center justify-between border-b-2 border-b-gray-200 mb-8">
...
const NavLink = ({ value, children }: NavLinkProps) => {
  return (
    <Tabs.Trigger value={value} className="px-4 py-2 text-base text-gray-600 hover:text-gray-800">
      {children}
    </Tabs.Trigger>
  );
};
