...
This page will guide you through creating a simple JavaScript/TypeScript Edge Function and deploy it on Lagon Cloud. The Function will be deployed globally in [multiple regions](/regions), and will be accessible through a unique URL.
