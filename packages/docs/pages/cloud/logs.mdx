You can use the [`console` API](/runtime-apis#console) to log messages, objects, errors, warnings, debug information and more.
...
Using [`lagon dev`](/cli#lagon-dev), logs are displayed in the terminal.
