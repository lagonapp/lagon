      ...
      <div className="grid gap-6 grid-cols-1 grid-rows-6 sm:grid-cols-2 sm:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2">
        <Card lineAnimation className="flex flex-col gap-4 p-12 rounded-2xl">
          ...
          <Text className="justify-self-end">
            All Functions have an HTTP endpoint by default, and you can also configure a CRON expression to
            automatically trigger your Function at the given interval.
          </Text>
        </Card>
        <Card lineAnimation className="flex flex-col gap-4 p-12 rounded-2xl">
          ...
          <Text>
            You can promote any previous Preview deployment to Production with a single click. The rollback is
            propagated globally in a few seconds.
          </Text>
        </Card>
        <Card lineAnimation className="flex flex-col gap-4 p-12 rounded-2xl">
        ...
        <Card lineAnimation className="flex flex-col gap-4 p-12 rounded-2xl">
          ...
          <Text>
            No need to learn new things - we use the same Web APIs you already know like Request and Response, so you
            can build faster with no vendor lock-in.
          </Text>
        </Card>
        <Card lineAnimation className="flex flex-col gap-4 p-12 rounded-2xl">
          <div className="rounded-full w-16 h-16 p-[1px] bg-gradient-to-b from-[#c797fa] to-[#6C04AC]">
